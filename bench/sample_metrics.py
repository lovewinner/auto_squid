...
FIELD_ORDER = [
    ...
    "sticky_probes_fired",      # 杠杆A:粘性命中后台探路实际发射次数
    "sticky_probe_evictions",   # 杠杆A:探路发现显著更快代理→驱逐粘性条目次数
    ...
    "established_pool_returned",# 隧道结束归还池次数(含竞速败者+预握手,库存化)
...
FIELD_DOCS = {
    ...
    "sticky_probes_fired": "杠杆A:粘性命中后台探路发射次数",
    "sticky_probe_evictions": "杠杆A:探路发现显著更快代理→驱逐粘性条目次数",
