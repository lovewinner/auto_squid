...
def start(config: str = "", proxies: str = "", db: str = "auto_squid.db"):
    ...
    router = Router(
        ...
        stagger_start=cfg.router.stagger_start,
        stagger_initial=cfg.router.stagger_initial,
        stagger_interval_ms=cfg.router.stagger_interval_ms,
        probe_interval_sec=cfg.router.circuit.probe_interval_sec,
        probe_canary=cfg.router.circuit.probe_canary,
        probe_canaries=[c.model_dump() for c in cfg.router.circuit.probe_canaries],
        circuit_threshold=cfg.router.circuit.circuit_threshold,
        ...
        single_send_degrade_fail=cfg.router.circuit.single_send_degrade_fail,
        single_send_degrade_ratio=cfg.router.circuit.single_send_degrade_ratio,
        single_send_degrade_slack_ms=cfg.router.circuit.single_send_degrade_slack_ms,
        auth_enabled=cfg.router.auth.enabled,
        auth_username=cfg.router.auth.username,
        auth_password=cfg.router.auth.password,
        enable_http_cache=cfg.router.http_cache.enabled,
        http_cache_ttl=cfg.router.http_cache.ttl,
        http_cache_max_entries=cfg.router.http_cache.max_entries,
        http_cache_max_bytes=cfg.router.http_cache.max_bytes,
        http_cache_stream_limit=cfg.router.http_cache.stream_cache_limit,
        ...
        adaptive_ttl=cfg.router.adaptive_ttl.enabled,
        adaptive_ttl_min=cfg.router.adaptive_ttl.min_sec,
        adaptive_ttl_max=cfg.router.adaptive_ttl.max_sec,
        switch_damping=cfg.router.switch_damping.enabled,
        switch_damping_min_wins=cfg.router.switch_damping.min_wins,
        switch_damping_ratio=cfg.router.switch_damping.ratio,
        switch_damping_abs_ms=cfg.router.switch_damping.abs_ms,
        concurrency_limit_enabled=cfg.router.concurrency_limit.enabled,
        concurrency_limit_initial=cfg.router.concurrency_limit.initial,
        concurrency_limit_min=cfg.router.concurrency_limit.min,
        concurrency_limit_max=cfg.router.concurrency_limit.max,
        concurrency_add_on_success=cfg.router.concurrency_limit.add_on_success,
        concurrency_mult_on_failure=cfg.router.concurrency_limit.mult_on_failure,
        concurrency_failure_window=cfg.router.concurrency_limit.failure_window,
        conn_pool_enabled=cfg.router.conn_pool.enabled,
        conn_pool_per_proxy=cfg.router.conn_pool.per_proxy,
        conn_pool_total=cfg.router.conn_pool.total,
        conn_pool_idle_timeout=cfg.router.conn_pool.idle_timeout,
        ...
        conn_pool_refill_pause_heartbeat_targets=list(cfg.router.conn_pool.refill_pause_heartbeat_targets),
